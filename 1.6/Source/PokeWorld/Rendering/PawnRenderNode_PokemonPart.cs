...
namespace PokeWorld
{
    internal class PawnRenderNode_PokemonPart : PawnRenderNode
    {
        public PawnRenderNode_PokemonPart(Pawn pawn, PawnRenderNodeProperties props, PawnRenderTree tree)
